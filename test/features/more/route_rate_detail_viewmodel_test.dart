...
void main() {
  ...
  test('edits a route rate and handles no selection', () async {
    ...
    when(
      () => sheets.showCustomSheet<RouteRate, RouteRate>(
    ...
    when(
      () => repository.addRouteRate(updated),
    ...
    verify(
      () => snackbar.showCustomSnackBar(
        message: 'Route rate updated successfully',
  ...
  test(
    'reports edit and archive failures, then archives successfully',
    () async {
      ...
      when(
        () => repository.archiveRouteRate('r1'),
